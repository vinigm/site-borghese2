    ...
    return `
      <article class="card-imovel" data-imovel-id="${imovel.id}">
        <div class="card-imovel__imagem-container">
          ...
          <!-- Botões overlay mobile -->
          <div class="card-imovel__acoes-mobile">
            <a href="${linkWhatsApp}" target="_blank" rel="noopener" class="card-imovel__acao-mobile card-imovel__acao-mobile--whatsapp" title="Falar no WhatsApp">
              ...
              <span class="card-imovel__acao-texto">Entre em contato!</span>
            </a>
            <a href="${detalhesBase}?id=${imovel.id}" class="card-imovel__acao-mobile card-imovel__acao-mobile--detalhes" title="Ver detalhes">
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <circle cx="12" cy="12" r="10"></circle>
                <line x1="12" y1="16" x2="12" y2="12"></line>
                <line x1="12" y1="8" x2="12.01" y2="8"></line>
              </svg>
              <span class="card-imovel__acao-texto">Mais Informações</span>
            </a>
          </div>
        </div>
